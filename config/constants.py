...
P_VITAL_STATUS_DISTRIBUTION_SEVERE_COVID = [0.1, 0.4, 0.5]  # (UNKNOWN_STATUS, ALIVE, DECEASED)
P_VITAL_STATUS_CAUSES_OF_DEATH_DISTRIBUTION = [0.05, 0.2, 0.05, 0.1, 0.3, 0.3]
P_COVID_CAUSE_OF_DEATH_GIVEN_SEVERE_COVID_AND_DEATH = 0.8
P_VITAL_STATUS_DECEASED_HAS_SURVIVAL_TIME = 0.8
VITAL_STATUS_SURVIVAL_TIME_DIST = (0, 100, 50, 20)  # low, high, mean, stdev

P_ADD_TOP_LEVEL_EXTRA_PROPERTIES = 0.8
ACTIVE_RECORD_STATUSES = ["Yes", "No", "Unknown", None]
ACTIVE_RECORD_STATUS_DISTRIBUTION = [0.6, 0.2, 0.1, 0.1]

# phenotypic feature probabilities
P_PF_HAS_SEVERITY = 0.9
PF_SEVERITY_DISTRIBUTION = [0.5, 0.2, 0.15, 0.1, 0.05]
P_PF_RECURRENT = 0.5
P_PF_HAS_EXTRA_PROPERTIES = 0.6

P_ADD_FAKE_CRAM_TO_1K_VCF = 0.5
P_ADD_EXPERIMENT_TO_BIOSAMPLE = 0.4
P_ADD_EXPERIMENT_LIBRARY_ID = 0.8
P_ADD_EXPERIMENT_LIBRARY_DESCRIPTION = 0.6
P_ADD_EXAMPLE_FILE_TO_EXPERIMENT = 0.3
P_ADD_LOCATION_COLLECTED_TO_BIOSAMPLE = 0.7
P_ADD_EXTRA_PROPERTIES_SOURCE_TO_BIOSAMPLE = 0.9
